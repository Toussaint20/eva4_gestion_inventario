"""
Django settings for eva4_gestion_inventario project.
...
ROOT_URLCONF = 'eva4_gestion_inventario.urls'
...
WSGI_APPLICATION = 'eva4_gestion_inventario.wsgi.application'
#implementación simple JWT
REST_FRAMEWORK = {
